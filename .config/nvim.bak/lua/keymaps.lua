...
-- Leader p to paste while keeping copied text in register (instead of deleted text)
...
-- Leader d to delete while keeping copied text in register (instead of deleted text)
